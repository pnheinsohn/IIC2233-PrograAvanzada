...
class MiVentana(QWidget):
    ...
    def init_GUI(self):
        ...
        """
        El uso del caracter & al inicio del texto de alg?n bot?n o men? permite
        que la primera letra del mensaje mostrado est? destacada. La
        visualizaci?n depende de la plataforma utilizada.
        """
